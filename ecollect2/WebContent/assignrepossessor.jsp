...
<body ng-app="App" ng-controller="repossessorsCtrl">
	<!-- Fixed navbar -->
	...
	<div class="container">
			<div class="row">
				<div class="col-md-6">
					<form name="newrepoForm" ng-submit="newrepofunc()" class="form-vertical">
						<div class="form-group">
							<label>Service Provider:</label>
							<select class="form-control selectpicker show-tick"
								title="Choose a repossessor ..." multiple ng-model="newrepossessor.repossessor" id="repossessor" name="repossessor"
								data-max-options="4" data-live-search="true">
							</select>
						</div>
						<div class="form-group">
							<label>Date of Instruction:</label>
							<input type="text" class="form-control" id="dateinst" name="dateinst" ng-model="newrepossessor.dateinst" readonly>
						</div>

						<div class="input-group">
							<label>Due date:</label>
							<input type="text" class="form-control form_date" id="duedate" name="duedate" ng-model="newrepossessor.duedate" required>
							<span class="input-group-addon" style="display:block">
									<span class="glyphicon glyphicon-calendar"></span></span>
						</div>
						<div class="checkbox">
						    <label><input type="checkbox" ng-model="newrepossessor.reviewdate"> Update review date</label>
						</div>
						<div class="form-group">
				...
				<div class="col-md-6">
					<div id="chart-container">Repossessors-Charts will load here!</div>
				</div>
			</div>
	</div>
				...
				$.ajax({
			        ...
			        success: function(data) {
			            ...
			            $.each(data,function (index, item) {
			                $('#repossessor').append("<option value='"+ item.SPTITLE +"' data-subtext=' EndOfIndemnity:"+item.ENDOFINDEMNITY+"'>"+ item.SPTITLE +" ("+item.PENDING+")"+"</option>");
			                $('#repossessor').selectpicker('refresh');
			            });
			        },complete: function() {}
			    });
