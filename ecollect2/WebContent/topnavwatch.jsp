...
<head>
    <meta charset="UTF-8" />
    <title>Activity Page watch</title>
  ...
  <script type="text/javascript" src="views/js/activityMainwatch.js"></script>
...
<script type="text/javascript">
  $(document).ready(function(){
	...
	$.ajax({
		type: 'GET',
        url: globalUrl+'/api/status/getactivitywatch/' + accnumber,
        success: function(data) {
        	// console.log('... getactivitywatch',data);
        	/*document.getElementById("firstname").innerHTML = data[0].CUSTNAME;
