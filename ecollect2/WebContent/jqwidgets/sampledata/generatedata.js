function generatedata(rowscount, hasNullValues) {
    ...
    for (var i = 0; i < rowscount; i++) {
        ...
        var accnumberindex = Math.floor(Math.random() * productNames.length);
        var custnumberindex = Math.floor(Math.random() * productNames.length);
        var price = parseFloat(priceValues[productindex]);
        var accnumber = accnumberValues[accnumberindex];
        var custnumber = custnumberValues[custnumberindex];
        ...
        row["price"] = price;
        row["accnumber"] = accnumber;
        row["custnumber"] = custnumber;
        row["quantity"] = quantity;
        row["total"] = price * quantity;
        row["totalarrears"] = Math.random() * 10;
        row["intarrears"] = Math.random() * 10;
